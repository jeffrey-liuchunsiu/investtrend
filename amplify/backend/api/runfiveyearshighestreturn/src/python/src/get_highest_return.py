...
def perform_backtest(symbol_list_length=5, investment=10000000, commission=5, start_date=None, end_date=None, interval='1d', print_result=True, print_detail=True):
